...
// Mock data for monthly consumption graph
const monthlyData = {
  labels: [
    "Nov",
    "Dec",
  ...
  datasets: [
    {
      ...
      // backgroundColor: "rgba(34, 197, 94, 0.8)", // green color for bars
      backgroundColor: "rgba(82, 183, 136, 1)",
      borderColor: "rgba(34, 197, 94, 1)",
      borderWidth: 1,
      hoverBackgroundColor: "rgba(56, 163, 165, 1)",
      hoverBorderColor: "rgba(56, 163, 165, 1)",
      data: [320, 290, 310, 400, 420, 390, 450, 430, 410, 380, 370, 400], // Example values
    },
  ],
};
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 border border-teal-200">
          ...
          <div className="relative" style={{ height: "300px" }}>
            <Bar
              ...
              height={300} // Specify the height to ensure it doesn't stretch
            />
          </div>
        </div>
      </div>
